...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "A server for Minecraft: Pocket Edition")
set(CPACK_PACKAGE_CONTACT "https://github.com/Christopher/mcpelauncher-manifest/issues")
...
if (DEB_OS_NAME MATCHES "ubuntu-xenial")
    set(CPACK_DEBIAN_PACKAGE_DEPENDS ",libc6 (>=2.14), libstdc++6, libcurl3, libx11-6, zlib1g")
    set(CPACK_DEBIAN_PACKAGE_VERSION "${CPACK_DEBIAN_PACKAGE_VERSION}~xenial")
elseif(DEB_OS_NAME MATCHES "ubuntu-bionic")
    set(CPACK_DEBIAN_PACKAGE_DEPENDS ",libc6 (>=2.14), libstdc++6, libcurl4, libx11-6, zlib1g")
